...
//
//     final intentPaymentModel = intentPaymentModelFromJson(jsonString);

import 'dart:convert';

PaymentIntentModel intentPaymentModelFromJson(String str) =>
    PaymentIntentModel.fromJson(json.decode(str));

String intentPaymentModelToJson(PaymentIntentModel data) =>
...
class PaymentIntentModel {
  ...
  factory PaymentIntentModel.fromJson(dynamic json) => PaymentIntentModel(
        id: json["id"],
        object: json["object"],
        amount: json["amount"],
